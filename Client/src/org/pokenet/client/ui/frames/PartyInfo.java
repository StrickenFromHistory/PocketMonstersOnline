...
public class PartyInfo extends Frame {
        ...
        public void initGUI(){
                int y = 0;
                try {
                        m_dpFont = new AngelCodeFont("pokeglobal/client/res/fonts/dp-small.fnt", "pokeglobal/client/res/fonts/dp-small.png");
                }
                catch(Exception e) {
                ...
                for (int i = 0; i < 6; i++){
                        ...
                        try{
                                ...
                                if (i != 0) {
                                        ...
                                        m_switchUp[i].addActionListener(
                                                        new ActionListener() {
                                ...
                                if (i != 5) {
                                        ...
                                        m_switchDown[i].addActionListener(
                                                        new ActionListener() {
                                                                public void actionPerformed(ActionEvent e) {
                                                                        packetGen.write("I" + String.valueOf(j) + String.valueOf(j + 1));
                                                                }
        ...
        public void loadImages(OurPokemon[] pokes){
                ...
                for (int i = 0; i < 6; i++){
                        ...
                        try{
                                m_pokeBall[i].setImage(new Image("pokeglobal/client/res/Pokeball.gif"));
                                m_pokeBall[i].setSize(30, 30);
                        } catch (SlickException e){}
                        try {   
                                if (pokes[i] != null) {
                                        m_level[i].setText("Lv: " + String.valueOf(pokes[i].getLevel()));
                                        m_level[i].pack();
