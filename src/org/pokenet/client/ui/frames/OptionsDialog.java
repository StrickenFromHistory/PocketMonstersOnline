        ...
        public void initGUI() {
                ...
                }
                {
                        ...
                        muteSound.setSelected(
                                        Boolean.parseBoolean(options.get("soundMuted")));
                        getContentPane().add(muteSound);
                }
                {
                        save = new Button("Save");
                        save.setSize(50, 25);
                        save.setLocation(0, 240);
                                ...
                                public void actionPerformed(ActionEvent e) {
                                        try {
                                                ...
                                                */
                                                ...
                                                GameClient.messageDialog("Changes will not take effect until you restart.",
                                                                getDisplay());
